...
non_quakes = list(filter(notaQuake, data["features"]))
# print out the number of remaining entries in the filtered dataset
print(f"Total non-quake events: {len(non_quakes)}")
for i in range (0, 10):
    print(non_quakes[i]["properties"]["type"])